...
#if 0
static SBIconView *makeIconViewForBundleIdentifier(NSString *bundleIdentifier) {
	SBApplicationController *ac = (SBApplicationController *)[%c(SBApplicationController) sharedInstance];
	SBApplication *app = nil;
	if (kCFCoreFoundationVersionNumber <= 800) {
		app = [ac applicationWithDisplayIdentifier:bundleIdentifier];
	} else {
		app = [ac applicationWithBundleIdentifier:bundleIdentifier];
	}
